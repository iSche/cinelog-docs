...
Éditer les lignes et écrire des commentaires fonctionnent entièrement hors ligne — les changements sont sauvegardés localement et se synchronisent à la reconnexion, comme tout le reste dans CineLog. La gestion du lien, non : créer, mettre à jour, révoquer et envoyer le lien exigent tous une connexion, et le site de validation lui-même n'est accessible qu'en ligne pour ton client.
...
*« Mon client dit que le code d'accès ne fonctionne pas. »* Il a probablement expiré — les codes durent 24 heures à partir de la première utilisation. Renvoie le lien depuis la boîte de dialogue Share ; un nouveau code est généré automatiquement et inclus dans l'e-mail.

*« Mon client ne peut ni commenter ni approuver. »* Deux causes probables : le lien est **View only** (vérifie le niveau d'accès dans la boîte de dialogue Share — le changer met à jour la même URL), ou le document a déjà été approuvé, ce qui verrouille le lien en lecture seule jusqu'au prochain **Send for review**.

*« Une ligne que j'avais approuvée est repassée en Rewrite. »* Attendu — tout nouveau commentaire ou réponse fait passer la ligne en Rewrite, tout comme modifier le contenu d'une ligne approuvée. Les deux sont traités comme « cette ligne a changé ou demande de l'attention après la validation ».

*« J'ai atteint une limite en envoyant en validation. »* L'offre gratuite inclut 3 tours Send for review par projet. Renvoyer par e-mail le lien d'un tour existant ne compte pas ; lancer de nouveaux tours, si. Passe à une offre supérieure pour des tours illimités.

*« Je n'ai pas reçu l'e-mail de retours. »* Il part une fois par tour — si un coéquipier l'a déjà reçu pour ce tour, il ne repartira pas avant le prochain **Send for review**. Vérifie aussi que ton rôle accorde l'accès au Script AV ; l'e-mail ne va qu'au propriétaire du projet et aux membres dont le rôle l'inclut.

*« Le client dit qu'il manque des lignes. »* Le Script AV est le découpage technique **linéaire**. Les plans qui n'existent que sur des tableaux grille ne sont pas des lignes AV et n'apparaissent jamais sur le site de validation.

*« Nous avons envoyé un nouveau tour et les commentaires du client ont disparu. »* Le site de validation ne montre que les commentaires du tour en cours. Rien n'est perdu — ton équipe voit l'historique complet de tous les tours dans l'application.
