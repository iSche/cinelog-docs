...
- Le client ne peut pas renouveler le code lui-même. Quand il expire, rouvre la boîte de dialogue Share — un code expiré est remplacé automatiquement par un nouveau, que tu peux copier pour ton client avec le lien. Renvoyer l'e-mail délivre aussi le nouveau code, mais sur un lien **Comment & Approve** cet appui sur **Send for review** lance un nouveau tour et compte dans les tours de l'offre gratuite (voir ci-dessous) — copier est la solution qui ne consomme pas de tour.
...
Sur l'offre gratuite, chaque projet dispose de **3 tours Send for review** ; les forfaits payants sont illimités. **Chaque appui sur Send for review consomme un tour** — y compris renvoyer le lien par e-mail. Copier le lien ou changer les options du lien n'en consomme jamais. Si tu atteins la limite, l'application propose une mise à niveau.
