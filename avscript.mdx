...
Display Settings cover Show PreVis, the PreVis aspect ratio, and the shot numbering format — the aspect ratio and numbering format are shared with the Shot List, so the script always matches the rest of your project.
