...
- `Shift + S`, once you're in Focus mode, opens the scene picker dialog — type a scene number to jump.
...
`Cmd / Ctrl + N` adds a new shot to the *highest-numbered* focused scene (the last one), then scrolls to the bottom of the list.
