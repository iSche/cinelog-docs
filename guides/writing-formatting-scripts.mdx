...
2. **Import Document:** Click the **Import** button in the top menu bar and select your script file.
...
- <kbd>Cmd</kbd> + <kbd>5</kbd>: Parenthetical
- <kbd>Cmd</kbd> + <kbd>6</kbd>: Transition
- <kbd>Cmd</kbd> + <kbd>7</kbd>: Lyrics
- <kbd>Cmd</kbd> + <kbd>E</kbd>: Centered
...
- **Word Metrics:** Total word count and character count.
