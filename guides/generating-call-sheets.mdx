...
description: "Daily call sheets in CineLog — header and call time, locations, schedule with time cascade, weather, personnel sections, rich-text crew message, sending and confirmation tracking, PDF export."
---
