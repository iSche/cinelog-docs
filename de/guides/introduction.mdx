...
Deine Session aktualisiert sich im Hintergrund selbst, wenn sie sich dem Ablauf nähert – meist ein paar Stunden vorher – sodass du, solange du in diesem Moment online bist, nie eine Anmeldeaufforderung siehst. Normale gemischte Online/Offline-Nutzung sorgt dafür, dass die Aktualisierung einfach funktioniert.

Wenn du lange genug komplett offline bleibst, damit die Session ablaufen kann – in der Größenordnung eines Monats – läuft sie ab. Beim nächsten Versuch der App, mit dem Server zu sprechen, erscheint ein Reauthentifizierungs-Dialog. Der Dialog ist blockierend, aber deine Daten bleiben erhalten: Melde dich mit demselben Konto wieder an und du machst genau dort weiter, wo du aufgehört hast, mit allen wartenden Bearbeitungen.
...
Alles, was du tippst, wird automatisch in einem etwa 450-ms-Debounce gespeichert, und das Schließen des Editors speichert, was darin steht. `Esc` hat in einem Textfeld kein besonderes Verwerf-Verhalten – es gibt keine "meine letzten Tastenanschläge wegwerfen"-Geste.
...
(Es gibt kein `Esc`-zum-Verwerfen in einem Textfeld; Bearbeitungen sind bereits automatisch gespeichert.)
