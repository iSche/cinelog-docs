...
description: "Tägliche Dispositionen (Dispo) in CineLog – Header und Call-Time, Drehorte, Plan mit Zeit-Kaskade, Wetter, Personensektionen, Rich-Text-Crew-Message, Versand und Bestätigungs-Tracking, PDF-Export."
---
...
Das wichtigste einzelne Feld. Setzt die Basis-Startzeit für den Tag (z.B. 08:00). Klicke darauf, um es zu bearbeiten. Diese Zeit verankert die Zeit-Kaskade des Plans (unten) und ist die Standardzeit, die jedem Empfänger gemailt wird, es sei denn, er hat eine persönliche Call-Time gesetzt (siehe [Personal](#personnel-sections)).
...
## Versand und Bestätigungs-Tracking
