...
Du kannst dieselbe Disposition nach dem Bearbeiten erneut senden (eine Drehbuchänderung, ein Crew-Tausch, eine Garderobennotiz). Das neue Senden erstellt einen neuen Batch auf der Confirmations-Seite; vorherige Batches bleiben für den Audit-Trail intakt.
